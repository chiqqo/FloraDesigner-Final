...
export const categories = ['All', 'Romantic', 'Seasonal', 'Classic', 'Wildflower', 'Tropical', 'Modern'];

export const allColors = ['All', 'Red', 'Pink', 'White', 'Yellow', 'Orange', 'Purple', 'Lavender', 'Blue', 'Green', 'Coral', 'Peach'];

export const allFlowers = [
  'All', 'Roses', 'Sunflowers', 'Peonies', 'Tulips', 'Lavender', 'Orchids',
  'Dahlias', 'Lilies', "Baby's Breath", 'Wildflowers',
];

export const sizes = ['All', 'Small', 'Medium', 'Large', 'Extra Large'];

export const occasions = [
  'All', 'Anniversary', 'Birthday', 'Wedding', 'Sympathy', "Mother's Day",
  'Housewarming', 'Corporate', 'Graduation', 'Everyday',
];
